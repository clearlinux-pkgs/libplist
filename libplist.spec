...
Version  : 2.5.0
Release  : 2
URL      : https://github.com/libimobiledevice/libplist/releases/download/2.5.0/libplist-2.5.0.tar.bz2
Source0  : https://github.com/libimobiledevice/libplist/releases/download/2.5.0/libplist-2.5.0.tar.bz2
...
%prep
%setup -q -n libplist-2.5.0
cd %{_builddir}/libplist-2.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715098581
...
/usr/lib64/libplist++-2.0.so.4.5.0
/usr/lib64/libplist-2.0.so.4
/usr/lib64/libplist-2.0.so.4.5.0
